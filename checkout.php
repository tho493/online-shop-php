	...
	<div class="container-fluid">
		<div class="row-checkout">
			...
			if (isset($_SESSION["uid"])) {
				$account = new account();
				$account->setUser_id($_SESSION["uid"]);
			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<input type="text" id="fname" class="form-control" name="firstname" pattern="^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9]+(\.[a-z]{2,4})$"  value="' . $row["first_name"] . ' ' . $row["last_name"] . '">
						...
						<input type="text" id="city" name="city" class="form-control" value="' . $row["address2"] . '" pattern="^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9]+(\.[a-z]{2,4})$" required>

						<div class="row">
						<div class="col-50">
							<label for="state">State</label>
							<input type="text" id="state" name="state" class="form-control" pattern="^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9]+(\.[a-z]{2,4})$" required>
						</div>
						<div class="col-50">
				...
				while ($i <= $total_count) {
					...
					$item_id_ = $_POST['item_id_' . $i];
					$amount_ = $_POST['item_price_' . $i];
					...
					echo "	
						<input type='hidden' name='prod_name_$i' value='$item_name_'>
						<input type='hidden' name='prod_id_$i' value='$item_id_'>
				...
				<input type="hidden" name="total_count" value="' . $total_count . '">
					...
					<input type="submit" id="submit" value="Thanh toán" class="checkout-btn">
				</form>
				</div>
			</div>
			';
