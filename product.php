			...
			if (!$result) {
				echo '
						<div class="col-md-5 col-md-push-2">
							<div class="no_item">
								<p>Không tìm thấy sản phẩm này. Nhấn vào <a href="index.php">đây</a> để quay lại</p>
							</div>
				...
				echo '
						...
						<div class="product-details">
							...
							<div>
								...
								<a class="review-link" href="#review-form">3 Review(s) | Add your review</a>
							</div>
							<div>
								<h3 class="product-price">$' . $row['product_price'] . '<del class="product-old-price">$' . $sale_pro_price . '</del></h3>
...
<!--							<ul class="product-links">
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															<h5 class="name">Mỵ cute</h5>
															<p class="date">27 DEC 23, 8:0 PM</p>
														...
														<div class="review-body">
															<p>Sản phẩm chất lượng tuyệt vời</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">Hoàn Cận</h5>
															<p class="date">29 DEC 2013, 10:40 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
														...
														<div class="review-body">
															<p>Sao lại có 1 sản phẩm rẻ thế này</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">Hoàng lolii</h5>
															<p class="date">10 DEC 2013, 8:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
		...
		<div class="section main main-raised">
			...
			$result = $product->getProduct_cat("product_cat=cat_id AND product_id BETWEEN $product_id AND $product_id+3");
			foreach ($result as $row) {
				...
				$sale_pro_price = $pro_price + $pro_price * 0.3;
